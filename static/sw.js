...
// setp 0 : Cache all static asstes
...
// setp 1 - intercept the fetch event
self.addEventListener('fetch', event =>{
    const req = event.request

    // check if the request is part of our appication asset
    // if it is then load from asset, dont go to the network
    ...
    event.respondWith(
        ...
        fetch(req)
            .then(resp => {
                ...
                //cache a copy of the response with the request as a key
                event.waitUntil(
            ...
            .catch(err =>{
                ...
                //Otherwise all other resource type, look it up in our asset cache
